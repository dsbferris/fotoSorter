...
_takeout_path = '/Users/ferris/Downloads/takeout_all/'
_download_path = '/Users/ferris/Downloads'
...
def move_image_with_json(path, f, json_file, new_path):
        ...
        if json_file is None:
            ...
            try:
                ...
                if dates[0] is None and dates[1] is None and dates[2] is None:
                    move_image_with_json(path, f, json_file, path_without_timestamp)
                else:
                ...
                move_image_with_json(path, f, json_file, path_cannot_handle)
                # print("Cannot handle file %s" % f)


if __name__ == "__main__":
    print("HELLO!")
    move_those_with_exif_timestamp(path=_takeout_path)
